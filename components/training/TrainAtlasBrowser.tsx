...
export default function TrainAtlasBrowser() {
  ...
  return (
    <div>
      <div className="atlasTabs" role="tablist" aria-label="Training domains">
        {TRAIN_DOMAINS.map((d) => (
      ...
      <p className="sec-sub" style={{ marginTop: "var(--s4)" }}>
        {TRAIN_DOMAINS.find((d) => d.id === domain)?.blurb}
      </p>
                ...
                <ul style={{ margin: "12px 0 0", padding: 0, listStyle: "none" }}>
                  ...
                  {t.kind === "scene" && t.scene && (
                    <li style={{ paddingTop: 10 }}>
                      <Link className="linkArrow" href={`/training/scenes/${t.scene}/`}>
                        OPEN THE EXHIBIT →
                      </Link>
                    </li>
                  )}
